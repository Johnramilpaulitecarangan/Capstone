<?php  
    ...
    $sql = "UPDATE reservation SET  organization_name = '$organization',name_of_event = '$event',gym_address = '$gym',requestdate = '$date',description = '$description',start_from = '$timestart',end_to = '$timeend' WHERE id = '$id' ";   if ($con->query($sql) === TRUE) {
