...
/*Schedule Date*/
    ...
    $sql = "INSERT INTO reservation( organization_name,name_of_event, gym_address, description, status,requestdate, start_from, end_to, requesterId) VALUES ('$organization', '$event','$gym', '$description','$status', '$date', '$timestart' , '$timeend', '$requesterId')";
