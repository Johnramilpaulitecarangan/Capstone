    ...
    <?php 
     if(isset($_POST['submited'])){
      ...
      $requesterId=$_POST['requesterId'];
       ...
       $sql = "INSERT INTO tblindigency( id, firstname, middlename, lastname, purpose, status,requesterId) VALUES 
       ('','$firstname', '$middlename','$lastname', '$purpose','$status','$requesterId')";
...
<form action="" class="box" method="POST">
  <div class="container">
    <h1 style="text-align: center;">Requesting Form of Barangay Indigency</h1></br>
    <hr><br>
    ...
    <input type="text" placeholder="Purpose of Request Form" name="purpose" id="purpose" required>
