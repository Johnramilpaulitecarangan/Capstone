...
<?php if(isset($_SESSION['UserLogin'])){?>
    ...
    $con = connection();
     $sql = "INSERT INTO tblcertificate( id, firstname, middlename, lastname, purok, purpose, status,requesterId) VALUES 
     ('', '$lastname', '$firstname', '$middlename', '$purok' , '$purpose','$status','$requesterId')";
...
<form action="" class="box" method="POST">
  <div class="container">
    ...
    <input type="hidden"  name="purok" value="<?php echo $row['purok'];?>"><br>
    <label for="resident"><b>Purpose:</b></label><br> 
