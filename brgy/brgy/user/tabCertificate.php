...
<div class="tab_bar">
    <ul >
        ...
        <li ><a href="tabcertificate.php" id="onlink">Certificate</a></li>
...
$res=mysqli_query($con,"select * from `tblcertificate` where requesterId ='".$_SESSION['userid']."'");
