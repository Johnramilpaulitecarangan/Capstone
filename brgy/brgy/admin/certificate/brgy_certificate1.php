...
<div class="main"> 
    ...
    <p class="sec2">(First Time Jobseekers Assistance Act - RA 11261)</p>
       <br><br><br>
       <p class="p2">This is to certify that <label contenteditable="true" class="under">&nbsp;<?php echo $row['firstname']. ' '. $row['middlename'].' ' .$row['lastname'];?>&nbsp;</label>
       , a resident of PUROK <label contenteditable="true" class="under">&nbsp;<?php echo $row['purok'];?> &nbsp;</label>,<b>BARANGAY ATATE  
        <p class="p1">PALAYAN CITY NUEVA ECIJA</b> for <b> 
        years and  months</b>, is a qualified availee 
...
<br><br><br>
<p class="p3">Signed this <label id="day" class="under"></label> <b>day of</b> 
<label id="month" class="under"></label> , 
<b><label id="year" class="under"></label></b>, in the City of Palayan , Nueva Ecija.</p>
<br><br>
