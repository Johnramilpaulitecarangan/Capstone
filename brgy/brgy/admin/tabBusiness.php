...
<body>
<div class="main">
<h1>Pending Request of Business Permit</h1>
<?php
$con=mysqli_connect('localhost','root','','barangaysystem');
$res=mysqli_query($con,"select * from tblbusiness order by requestdate ASC");
?>
...
<div class="tab_bar">
    <ul >
        ...
        <li ><a href="tabBusiness.php" id="onlink">Business Permit</a></li>
	...
	<table class="table">
		...
		<tbody>
            ...
            <td><?php 
                                           ...
                                           ?>  <?php }
                                            if( $row['status']  ==2){
                                                ?> <a href=" business/business_permit1.php?ID=<?php echo $row['id'];?>"><input type="hidden" id="request" style="color: Blue"  ><button class="print las la-print"></button></input></a>  <?php }
                                            if( $row['status']  ==3){
                                                ?> <?php }
                                            ?> </td>
