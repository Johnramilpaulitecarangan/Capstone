...
<br>
<p class="p3"><label contenteditable="true" class="under">&nbsp;<?php echo $row['firstname'].' '.$row['middlename'].'. '.$row['lastname'];?> &nbsp;</label></p>
...
<br>
<p class="p7">Issued this 
<label style="color:blue; font-size:14pt;"> <label id="day" class="under"></label> DAY OF 
