...
<p class="p3"><label contenteditable="true" class="under">&nbsp;<?php echo $row['businessName'];?> &nbsp;</label></p>
<br>
<p class="p3"><label contenteditable="true" class="under">&nbsp;<?php echo $row['name'];?> &nbsp;</label></p>
<p class="p4">Name of Business / OWNER</p><br>
<p class="p5">PUROK <label contenteditable="true" class="under">&nbsp;<?php echo $row['purok'];?> &nbsp;</label> ,BARANGAY ATATE, PALAYAN CITY</p>
<div class="line-2"></div>
<p class="p6">Business Address/Office Address</p>
<br>
<p class="p3"><input type="text" name="two" id="two4" value="<?php echo $row['businessType'];?>"></p>
...
<br>
<p class="p7">Issued this<label id="day" class="under"></label>
<label style="color:blue; font-size:14pt;">DAY OF 
<label id="month" class="under"></label> ,<label id="year" class="under"></label></label></p>
