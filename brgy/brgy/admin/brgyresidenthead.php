...
<h1>List Of Barangay Household Head</h1>


<div class="tab_bar">
    <ul >
   
        <li ><a href="brgyresidenthead.php" id="onlink" >Household Head</a></li>
        <li ><a href="brgyresident.php"    >Barangay Residents</a></li>
...
$res=mysqli_query($con,"select * from residents WHERE position = 'Head Family'");
