...
<div class="main"> 
    <p class="sec">BARANGAY CERTIFICATE OF INDIGENCY</p>
      ...
      <p class="p2">This is to certify that <label contenteditable="true" class="under">&nbsp;
        <?php echo $row['firstname']. ' '. $row['middlename'].' ' .$row['lastname'];?>&nbsp;</label> of legal age, is a</p>
     ...
     <p class="p3">Moral Character and an Active Member of the Community. She/He is one of</p>
        ...
        <p class="p3">person for   <input type="text" name="two" id="two2"  value="<?php echo $row['purpose'];?>"> purpose's.</p><br>
        <p class="p31">Given this  <label id="day" class="under"></label>
        day of <label id="month" class="under"></label>


        <label id="year" class="under"></label> here at</b></p>
