        ...
        <div class="sidebar1">
            <div class="sidebar-menu1">
                ...
                <li class="item1">
                    <a href="dashboard.php" class="menu-btn1">
                        <i class="las la-chalkboard-teacher"></i><span>DASHBOARD</span>
                    </a>
                </li>
                <li class="item1">
                    <a href="brgyofficial.php" class="menu-btn1">
                        <i class="las la-user"></i><span>BRGY OFFICIAL</span>
                    </a>
                </li>
                <li class="item1">
                    <a href="brgyresident.php" class="menu-btn1">
                        <i class="las la-users"></i><span>BRGY RESIDENT</span>
                    </a>
                </li>
                ...
                <li class="item1">
                    ...
                    <i class="las la-receipt"></i><span>PENDING REQUEST</span>
                    </a>
                </li>
                <li class="item1">
                    <a href="report.php" class="menu-btn1">
                    <i class="las la-chart-area"></i><span>REPORTS</span>
                    </a>
                </li>
                <li class="item1">
                    <a href="user.php" class="menu-btn1">
