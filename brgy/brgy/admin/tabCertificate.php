...
<body>
<div class="main">
<h1>Pending Request of Barangay Certifcate</h1>
<?php
$con=mysqli_connect('localhost','root','','barangaysystem');
$res=mysqli_query($con,"select * from tblcertificate order by requestdate ASC");
?>
...
<div class="tab_bar">
    <ul >
        ...
        <li ><a href="tabcertificate.php" id="onlink">Certifcate</a></li>
		...
		<tbody>
			...
			<tr>
              <td><?php 
                                           ...
                                           ?>  <?php }
                                            if( $row['status']  ==2){
                                                ?> <a href="certificate/brgy_certificate1.php?ID=<?php echo $row['id'];?>"><input type="hidden" id="request" style="color: Blue"  ><button class="print las la-print"></button></input></a>  <?php }
                                            if( $row['status']  ==3){
                                                ?> <?php }
                                            ?> </td>
