...
?>
  ...
  <h1>Requesting of Barangay Indigency</h1>
  <button class="add las la-print"><a href="indigency/brgy_indigencyall.php" >Print All</a></button>
...
<div class="table-responsive">
    ...
    <tr style="text-align:center; background: #009cd5;">
		...
		<tbody>
			...
			<tr>
      <td><a href="indigency/brgy_indigency.php?ID=<?php echo $row['id'];?>"><input type="hidden" id="request" style="color: Blue"  ><button class="las la-print"></button></input></a> </td>
