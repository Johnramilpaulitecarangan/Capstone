...
<div class="main"> 
    <p class="sec">BARANGAY CLEARANCE</p>
      ...
      <label contenteditable="true" class="under">&nbsp;<?php echo $row['age'];?> &nbsp;</label> </p>
     <p class="p3">years old, a Filipino Citizen, whose signature appears before, 
        ...
        <label contenteditable="true" class="under">&nbsp;<?php echo $row['purok'];?> &nbsp;</label>Barangay Atate,</p>
        <p class="p3"> Palayan City, Nueva Ecija.</p>
        <br>
        <p class="p2">Issued upon the request of the aforementioned name for the purpose of</p>
        <p class="p3"><input type="text" name="two" id="two4" ></p><br>
        <p class="p31">Issued this 
<label id="day" class="under"></label>
        DAY of 
<label id="month" class="under"></label>
        
<label id="year" class="under"></label> here at <b>Barangay</b></p>
