			...
			<div class="bg-white shadow rounded-lg d-block d-sm-flex">
				...
				<div class="tab-content p-4 p-md-5">
					<div class="tab-pane fade show active" id="account" >
						...
						<form action="resident/update.php"  method="post" enctype="multipart/form-data">
						<div class="row">
...
/>
 ...
 id="relation" ?>">
						...
						<option value="GrandFather"<?php echo ($row['relation'] == "GrandFather")? 'Selected' : '';?>>GrandFather</option>
							  <option value="GrandMother" <?php echo ($row['relation'] == "GrandMother")? 'Selected' : '';?>>GrandMother</option>
                              <option value="Father" <?php echo ($row['relation'] == "Father")? 'Selected' : '';?>>Father</option>
                              <option value="Husband" <?php echo ($row['relation'] == "Husband")? 'Selected' : '';?>>Husband</option>
                              <option value="Wife"<?php echo ($row['relation'] == "Wife")? 'Selected' : '';?>>Wife</option>
                              <option value="Mother"<?php echo ($row['relation'] == "Mother")? 'Selected' : '';?>>Mother</option>
                              <option value="Brother"<?php echo ($row['relation'] == "Brother")? 'Selected' : '';?>>Brother</option>
                              <option value="Sister"<?php echo ($row['relation'] == "Sister")? 'Selected' : '';?>>Sister</option>
                              <option value="Son"<?php echo ($row['relation'] == "Son")? 'Selected' : '';?>>Son</option>
                              <option value="Daugther"<?php echo ($row['relation'] == "Daugther")? 'Selected' : '';?>>Daugther</option>
                              <option value="Other"<?php echo ($row['relation'] == "Other")? 'Selected' : '';?>>Other</option>
            </select>
								</div>
							</div>
 ...
 id="employment" ?>">
						...
						<option  value="None" <?php echo ($row['employment'] == "None")? 'Selected' : '';?> >N/A</option>
            </select>
								</div>
							</div>
